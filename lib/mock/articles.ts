...
export const mockArticles: Article[] = [
  {
    ...
    badges: [
      { label: "Rəsmi Protokol", icon: "verified", tone: "secondary" },
      { label: "ESC 2024", tone: "neutral" },
    ],
    tags: ["Kardiologiya", "Profilaktika", "Stress"],
    author: mockAuthor,
    doctorNote:
      "Həkimin şərhi: «Stress fonunda artan kortizol damar spazmını sürətləndirir...»",
    likeCount: 142,
    commentCount: 18,
    tableOfContents: [
      {
...

  {
    ...
    badges: [
      { label: "Rəy verilib", icon: "verified", tone: "secondary" },
      { label: "Ekspert Təhlili", tone: "neutral" },
    ],
...

  {
    ...
    viewCount: 2740,
    badges: [{ label: "EKQ Diaqnostika", icon: "ecg", tone: "neutral" }],
    tags: ["Aritmiya"],
    author: mockAuthor,
    likeCount: 64,
    commentCount: 7,
...

  {
    ...
    viewCount: 6430,
    isPeerReviewed: true,
    badges: [{ label: "Klinik Rəy", icon: "school", tone: "tertiary" }],
    tags: ["Profilaktika", "Xolesterin"],
    author: mockAuthor,
    likeCount: 175,
    commentCount: 21,
    tableOfContents: [
...

  {
    ...
    viewCount: 3980,
    isPeerReviewed: true,
    badges: [{ label: "Klinik Tədqiqat", icon: "biotech", tone: "secondary" }],
    tags: ["Həyat Tərzi", "Qidalanma"],
    author: mockAuthor,
    likeCount: 96,
    commentCount: 11,
    tableOfContents: [
...

  {
    ...
    isFeatured: true,
    isPeerReviewed: true,
    journalLabel: "Həftənin Mövzusu • Dərin Elmi Analiz",
    badges: [
      { label: "Dərin Elmi Analiz", icon: "auto_awesome", tone: "tertiary" },
    ],
    tags: ["Ürək çatışmazlığı", "Farmakologiya"],
    author: mockAuthor,
    likeCount: 240,
    commentCount: 32,
    tableOfContents: [
